...
In particular, we have deployed a preliminary prototype of discovery in two different organizations\mourad{Would it possible to put more details on these two use cases, especially in terms of concrete results. We've the space and we need to fill it!}. 
...
from here}\dong{Raul, shall we keep this table or not?}\mourad{It's not very informative, just put numbers whenever necessary in the text.}}\label{tab:dataCivInTheWild}
