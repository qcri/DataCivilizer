...
We also assume that the user has identified the subset of each source table in which he is interested\mourad{Is this assumption needed, it's just specifying a predicate!?}. 
...
This gives us a mechanism to assign a cleanliness estimate to any non-key attribute\mourad{It's not clear how the combination of estimates lead to assigning estimates to non-key attributes?}. 
