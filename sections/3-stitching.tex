...
\zia{I also think that we can remove Table 1. Furthermore, I would not formally introduce INDs and FKs. I believe one sentence each suffices for this paper.}
