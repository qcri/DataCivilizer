...
\nan{I don't think that to use  $> 1.5$ columns (with more examples later) for error-robust inclusion dependency in a CIDR paper is a good idea.}
\zia{Furthermore, I would not formally introduce INDs and FKs. I believe one sentence each suffices for this paper.}
...
\dong{I think we do not need an algorithm for finding \eind here, right?}
