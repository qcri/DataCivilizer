...
The linkage graph is a hyper-graph where each node represents a column and edges represent a relationship between nodes of the graph. Note the hyper-edges can express relationships involving more than two columns, such as compound keys and within the same table. 
