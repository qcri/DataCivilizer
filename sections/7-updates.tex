...
\stitle{(1) Insertions/deletions on source tables.} This happens when there is a change to a table, e.g., an insertion of new procurement record in the M.I.T. Data Warehouse. This may also happen when some data sources get cleaned (see Section~\ref{sec:curating}).
