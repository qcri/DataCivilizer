...
% In this section we first give a cleanliness model to estimate the recall of the path query result (Section~\ref{subsec:model:recall}). Then we give another cleanliness model to estimate the precision of the path query result (Section~\ref{subsec:model:precision}). Finally we discuss how to achieve the maximum quality gain with a given budget for the path query result (Section~\ref{subsec:gain}).
