...
An oft cited statistic is that that data scientists spend at least
$X$\% of their time finding, preparing, integrating and cleaning data set
...
at MIT, QCRI and Waterloo, whose main purpose  is to decrease $X$, by helping data scientists quickly find and query data of interest from large numbers of tables, allowing 
