...
Our plan is to leverage the \texttt{BigDAWG} polystore system~\cite{DBLP:journals/pvldb/ElmoreDSBCGHHKK15} we are building to  pull data from multiple underlying storage engines to compute the final result (or a {\em view}) that satisfies the user's specifications.
