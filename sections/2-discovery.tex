...
and InfoGather~\cite{DBLP:conf/sigmod/YakoutGCC12}. These systems, however, are
designed to solve a limited number of use cases of relevance for the companies
where they are deployed. Unlike them, our discovery module aims to support
general discovery queries that can then be used for unanticipated discovery
