...
Dong Deng$^{\infty}$~~~Raul Castro Fernandez$^{\infty}$~~~Ziawasch Abedjan$^{\ddag}$~~~Sibo Wang$^{\dagger}$\titlenote{Work done while doing an internship at QCRI.} \\
Ahmed Elmagarmid$^{\sharp}$~~~Ihab F. Ilyas$^\ell$~~~Samuel Madden$^{\infty}$~~~Mourad Ouzzani$^{\sharp}$~~~Nan Tang$^{\sharp}$\\\vspace{.25em}
...
\email{\{dongdeng, raulcf, madden\}@csail.mit.edu~~abedjan@tu-berlin.de\\swang@ntu.edu.sg~~ilyas@uwaterloo.ca~~
