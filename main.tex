...
Dong Deng$^{\infty}$~~~Raul Castro Fernandez$^{\infty}$~~~Ziawasch Abedjan$^{\ddag}$\\\vspace{-.05em}Sibo Wang$^{\dagger}$\titlenote{Work done while doing an internship at QCRI.}~~~Michael Stonebraker$^{\infty}$~~~
Ahmed Elmagarmid$^{\sharp}$\\\vspace{.2em}Ihab F. Ilyas$^\ell$~~~Samuel Madden$^{\infty}$~~~Mourad Ouzzani$^{\sharp}$~~~Nan Tang$^{\sharp}$\\
\vspace{1ex}
\affaddr{$^{\infty}$~MIT CSAIL~~~$^{\ddag}$~TU Berlin~~~$^{\dagger}$~Nanyang Technological University\\$^{\sharp}$~Qatar Computing Research Institute, HBKU~~~$^\ell$~University of Waterloo} \\\vspace{.1em}
\vspace{1ex}
\email{\{dongdeng, raulcf, stonebraker, madden\}@csail.mit.edu\\
abedjan@tu-berlin.de~~swang@ntu.edu.sg~~ilyas@uwaterloo.ca\\
